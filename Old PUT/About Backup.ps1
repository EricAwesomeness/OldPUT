...
$basicForm = New-Object System.Windows.Forms.Form
    $basicForm.Text = "P.U.T. Version: 6.11.0"
    ...
    $basicForm.Icon = New-Object system.drawing.icon '\\tahr-support01\support\PUT\icon.ico'


$pictureBox = new-object Windows.Forms.PictureBox 
    $art = [system.drawing.image]::FromFile("\\tahr-support01\support\PUT\ART1.png")
...
$toplabel.Text = "Powershell Utility Toolkit`n`nVersion: 6.11.0 `n`nCreated: 07/29/20 `n`nModified: 09/20/20 `n`nAuthor: Eric Butler `n`nFor Feature Requests or Feedback Reach out at eric.butler@seminolehardrock.com"
...
$CLNext.Add_Click({
    if($global:vcount -lt 3){$global:vcount = $global:vcount + 1}
...
$versionlist = @($6102,$6103,$6104,$6110)
$global:vcount = 3
$displayedversion = $versionlist[$global:vcount]
$bottomlabel.Text = $displayedversion
